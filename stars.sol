...
constructor (uint256 _initialSupply,address _gameContractAddress) public {
        ownerAddress=msg.sender;
       //alanceowner=msg.sender;
...
function changeSeason()public payable onlyOwner{
    ...
    //balances[ownerAddress][currentSeason.sub(1)]=0;
}
